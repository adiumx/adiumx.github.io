...
<head>
    ...
    <title>César Ruiz Flores</title>
</head>

<body>
    <header class="mt-0 pt-0">
        <div class="bg-cover clearfix pt-3">
            <h2 class="logo">César Ruiz Flores</h2>
            <nav class="nav nav-fill mx-auto">
                <li class="nav-item">
                    <a class="nav-link" href="https://www.facebook.com/Aadium/" target="_blank"><i
    ...
    <footer class="container-fluid pt-5">
        <div class="container">
            <h2 class="logo text-center">César Ruiz Flores</h2>
        ...
        <div class="copyright mt-4">
            <p class="text-center">&copy; 2019 <a href="#" class="text-white">César Ruiz Flores</a>. All Rights Reserved. Design
