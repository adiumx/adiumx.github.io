...
const TRADUCCIONES = {
  es: {
    ...
    bio_text_2: 'Al mismo tiempo, me apasiona la inteligencia artificial: actualmente trabajo en un asistente de voz que detecta una palabra de activación y silencios para interactuar con modelos de lenguaje.',
    bio_text_3: 'Además de mi formación técnica, disfruto la música y el dibujo, que me inspiran a mantener un estilo funcional y estético en mis proyectos.',
  ...
  en: {
    ...
    bio_text_2: 'At the same time, I am passionate about artificial intelligence: I am currently building a voice assistant that detects a wake word and silences in order to interact with language models.',
    bio_text_3: 'Beyond my technical background, I enjoy music and drawing, which inspire me to keep a functional and aesthetic style in my projects.',
    p1: 'Capstone project',
